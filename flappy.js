...
FlappyBird.prototype = {
	...
	startX: 90, // 起始位置  
	startY: 225,
	obsDistance: 300, // 上下障碍物距离  
	obsSpeed: 2, // 障碍物移动速度  
	obsInterval: 6000, // 制造障碍物间隔ms  
	upSpeed: 2, // 上升速度  
	downSpeed: 1, // 下降速度  
	line: 25, // 地面高度
	score: 0, // 得分  
	...
	CreateMap: function() {
		...
		//setu1p();
		this.bg = new Image();
		this.bg.src = "img/background2.png";
		var startBg = new Image();
		startBg.src = "img/background2.png";
	...
	Checkpostion: function(){
		this.UpdateData();
		//if (this.previous!=this.recent){
		if(this.recent=='D'){
			this.touch = true;
			console.log("the status previous:"+this.previous);
			console.log("the status recent:"+this.recent);
		}
		else{
			this.touch = false;
		}
...
// function change_postion(){
// 	recent=poseLabel;
// 	if (previous!=recent){
// 		game.touch = true;
// 		console.log("the status previous:"+previous);
// 		console.log("the status previous:"+recent);
// 	}
// 	else{
// 		game.touch = false;
// 	}
